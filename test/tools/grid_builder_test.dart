...
void main() {
  test('Grid Builder Smoke Test', () async {
    final result = await Process.run(
      'dart',
      ['bin/grid_builder.dart', '--width=11', '--seed=123'],
    );
    ...
    expect(result.stdout, contains('static final english11x'), reason: "Output missing GridDefinition");
  });
